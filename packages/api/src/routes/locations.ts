  ...
  fastify.get(
    ...
    async (request: any, reply) => {
      try {
        ...
        const locationFilter = ['owner', 'admin', 'manager', 'buyer'].includes(
          request.member!.role
        )
          ? {}
        ...
        reply
          .code(500)
          .send({ success: false, error: 'Failed to fetch locations' })
      }
    }
  )
      ...
      try {
        ...
        if (error.code === 'P2002') {
          reply
            ...
            .send({
              success: false,
              error: 'Location name or code already exists',
            })
          return
        }
        ...
        reply
          .code(500)
          .send({ success: false, error: 'Failed to create location' })
      }
    }
  )
  ...
  fastify.put(
    ...
    async (request: any, reply) => {
      ...
      try {
        ...
        reply
          .code(500)
          .send({ success: false, error: 'Failed to update location' })
      }
    }
  )
  ...
  fastify.delete(
    ...
    async (request: any, reply) => {
      ...
      try {
        ...
        reply
          .code(500)
          .send({ success: false, error: 'Failed to delete location' })
      }
    }
  )
  ...
  fastify.get(
    ...
    async (request: any, reply) => {
      ...
      try {
        ...
        reply
          .code(500)
          .send({ success: false, error: 'Failed to fetch location inventory' })
      }
    }
  )
