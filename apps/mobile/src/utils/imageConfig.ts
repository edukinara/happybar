...
export const getOptimalImageSize = (containerSize: number, devicePixelRatio: number = 1) => {
...
export const generateResponsiveImageSource = (baseUri: string, size: number): ImageSource => {
