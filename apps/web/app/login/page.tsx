...
function LoginPageContent() {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center relative overflow-hidden p-4'>
      ...
      <Card className='relative z-10 border-purple-100 dark:border-purple-900/50 shadow-xl bg-white/95 dark:bg-neutral-900/95 backdrop-blur overflow-hidden p-0'>
