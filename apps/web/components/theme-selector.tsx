...
export function ThemeSelector() {
  ...
  const themes = [
    ...
    { 
      ...
      preview: resolvedTheme === 'dark' ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-200'
    },
  ]
        ...
        return (
          ...
          >
            <CardContent className="p-4">
              {/* Preview */}
              <div className={`h-20 rounded-md border mb-3 flex items-center justify-center ${themeOption.preview}`}>
