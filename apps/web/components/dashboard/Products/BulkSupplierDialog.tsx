          ...
          try {
            ...
            if (!alreadyExists) {
              await suppliersApi.addProductToSupplier(supplierId, {
                ...
                costPerCase: product.costPerCase || (product.costPerUnit * product.caseSize),
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='max-w-2xl'>
        <DialogHeader>
          ...
          <DialogDescription>
            Assign {selectedProducts.length} selected product{selectedProducts.length !== 1 ? 's' : ''} to one or more suppliers
          </DialogDescription>
        </DialogHeader>
        ...
        <div className='space-y-4'>
          ...
          <div className='space-y-3'>
            ...
            <p className='text-xs text-muted-foreground'>
              Each product will use its own configured cost and pack size. 
              You can adjust individual settings later in the product edit page.
            </p>
          </div>
        </div>
